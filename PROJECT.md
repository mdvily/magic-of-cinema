...
### ⏳ Still to wire (v0.4+)
- Install giscus GitHub app (manual)
- Configure Vercel outgoing webhook for Telegram pings (manual)
- Custom 404 page
- MovieMan-authored per-category rubric content on About page
- Maybe: TinaCMS-fired publish ping (separate from Vercel deploy ping)
